...
const footerSections = [
  {
    ...
    links: [
      ...
      { label: 'CNG Stations', path: '/cng' },
      { label: 'Petrol Stations', path: '/petrol' },
      { label: 'Diesel Hubs', path: '/diesel' },
  ...
  },
  {
    title: 'Solutions',
    links: [
      { label: 'Fleet Management', path: '/ev/fleet' },
      { label: 'Queue Predictor', path: '/queue-predictor' },
      { label: 'AI Recommendations', path: '/route-planner' },
          ...
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              ...
              <p className="footer__tagline">
                India's unified fuel navigation platform. Find stations, plan routes, and skip the queues with AI.
              </p>
      ...
      <div className="footer__bottom">
        <div className="container">
          <div className="footer__bottom-inner">
            <p className="footer__copyright">© 2026 Fuel-India Technologies Pvt. Ltd. All rights reserved.</p>
            <p className="footer__made">Made with 💚 in India</p>
          </div>
        </div>
      </div>
    </footer>
